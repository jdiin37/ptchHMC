<%@ Page Title="套餐流程維護" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PkgRunDown.aspx.cs" Inherits="HMCSys.PkgRunDown" %>
					...
					<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
						...
						<Columns>   
                            <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:Label id="LabelPid" runat ="server" text='<%# Eval("ParentID")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>   
                            ...
                            <asp:TemplateField HeaderText="所屬類別">
								<ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text="" CssClass="label label-info"></asp:Label>
								</ItemTemplate>
							</asp:TemplateField>
